    ...
    public function run()
    {
        if(count(ItemGift::all()) == 0) {
            $item_gift1 = ItemGift::create([
                ...
                'item_gift_name' => 'Samsung Galaxy S9 - Midnight Black 4/64 GB',
                'item_gift_slug' => Str::slug('Samsung Galaxy S9 - Midnight Black 4/64 GB'),
            ...
            $item_gift2 = ItemGift::create([
                'item_gift_code' => Str::random(15),
                'item_gift_name' => 'iPhone 12 Pro - Pacific Blue 6/128 GB',
                'item_gift_slug' => Str::slug('iPhone 12 Pro - Pacific Blue 6/128 GB'),
            ...
            $item_gift3 = ItemGift::create([
                'item_gift_code' => Str::random(15),
                'item_gift_name' => 'Xiaomi Redmi Note 10 Pro - Dark Night 8/128 GB',
                'item_gift_slug' => Str::slug('Xiaomi Redmi Note 10 Pro - Dark Night 8/128 GB'),
            ...
            $item_gift4 = ItemGift::create([
                'item_gift_code' => Str::random(15),
                'item_gift_name' => 'Google Pixel 5 - Just Black 8/128 GB',
                'item_gift_slug' => Str::slug('Google Pixel 5 - Just Black 8/128 GB'),
            ...
            $item_gift5 = ItemGift::create([
                'item_gift_code' => Str::random(15),
                'item_gift_name' => 'OnePlus 9 Pro - Morning Mist 12/256 GB',
                'item_gift_slug' => Str::slug('OnePlus 9 Pro - Morning Mist 12/256 GB'),
