...
return [
	...
	"variant_out_of_stock"						  => "Stok tidak tersedia, product ID: :id dengan varian ID: :variant_id",
	"already_reviews"							  => "Anda sudah memberi review pada order ID: :order_id & product ID: :product_id",
	...
	"variant_not_found_in_products"               => "Varian tidak tersedia pada product ID: :id",
	"variant_not_available_in_products"           => "Varian ID: :variant_id tidak tersedia pada product ID: :id",
	"variant_required"                            => "Product ID: :id memiliki varian",
	"exists_image_variant_products"               => "Product ID: :id dan varian ID: :variant_id sudah memiliki gambar",
