...
return [
	...
	"variant_out_of_stock"						  => "Out of stock, product ID: :id with variant ID: :variant_id",
	"already_reviews"							  => "You have already given a review on the order ID: :order_id & product ID: :product_id",
	...
	"variant_not_found_in_products"               => "Variants are not available on this product ID: :id",
	"variant_not_available_in_products"           => "Variant ID: :variant_id not available on product ID: :id",
	"variant_required"                            => "Product ID: :id has variants",
	"exists_image_variant_products"               => "Product ID: :id and variant ID: :variant_id has exists images",
