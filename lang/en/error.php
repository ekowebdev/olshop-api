...
return [
	...
	"variant_not_found_in_item_gifts"             => "Variants are not available on this item gift ID: :id",
	"variant_not_available_in_item_gifts"         => "Variant ID: :variant_id are not available on item gift ID: :id",
